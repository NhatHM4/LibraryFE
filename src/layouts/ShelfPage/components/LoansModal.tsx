...
const LoansModal: React.FC<{shelfCurrentLoan: ShelfCurrentLoans, mobile : boolean, handleReturnBook : any, handleRenewBook :any}> = (props) => {
  return (
                            ...
                            <div className='mt-3'>
                                <div className='row'>
                                    ...
                                    <div className='list-group mt-3'>
                                        <button data-bs-dismiss='modal' className='list-group-item list-group-item-action' aria-current='true' onClick={()=>{props.handleReturnBook()}}>
                                                Return Book
                                        </button>
                                        <button onClick={()=>{props.handleRenewBook()}} data-bs-dismiss='modal' className={props.shelfCurrentLoan.daysLeft < 0 ? 
